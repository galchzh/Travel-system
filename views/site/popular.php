...
$this->title = '3 World popular places';
?>
...
<div class="wrapperr">
  <div class="containerr" id="c0">
    ...
    <div class="story" id="s0">
      <div class="info">
      <h3 id="hh3">Pyramids</h3>
      <p id="pp"> Built during a time when Egypt was one of the richest and most powerful civilizations in the world. Their massive scale reflects the unique role that the pharaoh played in ancient Egyptian society.</p>
      </div>
    </div>
  </div>
  <div class="containerr" id="c1">
    ...
    <div class="story" id="s1">
      <div class="info">
        <h3 id="hh3">Stonehenge</h3>
      <p id="pp"> Stonehenge is a prehistoric monument in Wiltshire, England. It was constructed in several stages between 3000 and 1500 B.C., spanninng to the Bronze Age.</p>
      </div>
    </div>
  </div>
  <div class="containerr" id="c2">
    ...
    <div class="story" id="s2">
      <div class="info">
      <h3 id="hh3">Tower of Pisa</h3>
      <p id="pp"> The Leaning Tower of Pisa or simply the Tower of Pisa is the campanile, or freestanding bell tower, of the cathedral of the Italian city of Pisa, known worldwide for its unintended tilt</p>
 </div>
    </div>
  </div>

  <div class="page">
  <h4 id="hh4">Hover the card</h4>
  <ul><li id="lii"> <<< </li>
